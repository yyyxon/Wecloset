...
public class CommentsDeleteController implements Action  {
	
	
	private final Logger logger = LogManager.getLogger(CommentsDeleteController.class);
	
	private static CommentsDeleteController instance;
	
	private CommentsDeleteController() {
	}
	
	public static CommentsDeleteController getInstance() {				
		if (instance == null)
			instance = new CommentsDeleteController();
		return instance;
	}
	...
	private void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {		
		...
		try {
			...
			/**댓글 삭제 */
			boardDAO.deleteComment(Integer.parseInt(commentID));
