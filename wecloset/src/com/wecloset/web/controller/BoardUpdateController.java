...
public class BoardUpdateController implements Action {
	...
	private final Logger logger = LogManager.getLogger(BoardUpdateController.class);
	
	private static BoardUpdateController instance;
	...
	public static BoardUpdateController getInstance() {				
		if (instance == null)
			instance = new BoardUpdateController();
		return instance;
	}
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (request.getMethod().equals("POST")) {
			...
			/** getBoardInfo null 값 체크 및 작성자와 로그인한 유저가 같은지 체크 , 널 및 숨김 처리 체크 */
			...
			String pageUrl ="/WEB-INF/jsp/board_update.jsp";						
