...
public class DailyWriteController implements Action {

	private final Logger logger = LogManager.getLogger(DailyWriteController.class);
	
	private static DailyWriteController instance;
	
	private DailyWriteController() {
	}
	
	public static DailyWriteController getInstance() {				
		if (instance == null)
			instance = new DailyWriteController();
		return instance;
	}
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (request.getMethod().equals("POST")) {
			...
			String pageUrl ="/WEB-INF/jsp/daily_write.jsp";		
